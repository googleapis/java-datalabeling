...
The Maven artifact coordinates (`com.google.cloud:google-cloud-datalabeling`) remain the same.
...
```Groovy
implementation 'com.google.cloud:google-cloud-datalabeling:0.126.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-datalabeling" % "0.126.0"
```
