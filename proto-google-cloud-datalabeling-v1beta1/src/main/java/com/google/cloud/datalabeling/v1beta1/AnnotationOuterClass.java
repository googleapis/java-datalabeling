  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "oogle/api/resource.proto\032;google/cloud/datalabeling/v1beta1/annotation_spec_set."
          + "proto\032\036google/protobuf/duration.proto\"\342\002\n\n"
          + "Annotation\022\014\n"
          + "\004name\030\001 \001(\t\022N\n"
          + "\021annotation_source\030\002"
          + " \001(\01623.google.cloud.datalabeling.v1beta1.AnnotationSource\022L\n"
          + "\020annotation_value\030\003"
          + " \001(\01322.google.cloud.datalabeling.v1beta1.AnnotationValue\022R\n"
          + "\023annotation_metadata\030\004"
          + " \001(\01325.google.cloud.datalabeling.v1beta1.AnnotationMetadata\022T\n"
          + "\024annotation_sentiment\030\006"
          + " \001(\01626.google.cloud.datalabeling.v1beta1.AnnotationSentiment\"\321\007\n"
          + "\017AnnotationValue\022k\n"
          + "\037image_classification_annotation\030\001 \001(\0132@.google.cloud.datalabel"
          + "ing.v1beta1.ImageClassificationAnnotationH\000\022h\n"
          + "\036image_bounding_poly_annotation\030\002 "
          + "\001(\0132>.google.cloud.datalabeling.v1beta1.ImageBoundingPolyAnnotationH\000\022_\n"
          + "\031image_polyline_annotation\030\010 \001(\0132:.google.cloud."
          + "datalabeling.v1beta1.ImagePolylineAnnotationH\000\022g\n"
          + "\035image_segmentation_annotation\030\t"
          + " \001(\0132>.google.cloud.datalabeling.v1beta1.ImageSegmentationAnnotationH\000\022i\n"
          + "\036text_classification_annotation\030\003 \001(\0132?.google"
          + ".cloud.datalabeling.v1beta1.TextClassificationAnnotationH\000\022n\n"
          + "!text_entity_extraction_annotation\030\n"
          + " \001(\0132A.google.cloud.dat"
          + "alabeling.v1beta1.TextEntityExtractionAnnotationH\000\022k\n"
          + "\037video_classification_annotation\030\004 \001(\0132@.google.cloud.datalabeling."
          + "v1beta1.VideoClassificationAnnotationH\000\022l\n"
          + " video_object_tracking_annotation\030\005 \001("
          + "\0132@.google.cloud.datalabeling.v1beta1.VideoObjectTrackingAnnotationH\000\022Y\n"
          + "\026video_event_annotation\030\006 \001(\01327.google.cloud.dat"
          + "alabeling.v1beta1.VideoEventAnnotationH\000B\014\n\n"
          + "value_type\"k\n"
          + "\035ImageClassificationAnnotation\022J\n"
          + "\017annotation_spec\030\001 \001(\01321.googl"
          + "e.cloud.datalabeling.v1beta1.AnnotationSpec\"\036\n"
          + "\006Vertex\022\t\n"
          ...
          + " \003(\01323.google.cloud.datalabeling.v1beta1.NormalizedVertex\"\242\002\n"
          + "\033ImageBoundingPolyAnnotation\022H\n\r"
          + "bounding_poly\030\002 \001(\0132/."
          + "google.cloud.datalabeling.v1beta1.BoundingPolyH\000\022]\n"
          + "\030normalized_bounding_poly\030\003 \001"
          + "(\01329.google.cloud.datalabeling.v1beta1.NormalizedBoundingPolyH\000\022J\n"
          + "\017annotation_spec\030\001"
          + " \001(\01321.google.cloud.datalabeling.v1beta1.AnnotationSpecB\016\n"
          + "\014bounded_area\"G\n"
          + "\010Polyline\022;\n"
          ...
          + "3.google.cloud.datalabeling.v1beta1.NormalizedVertex\"\204\002\n"
          + "\027ImagePolylineAnnotation\022?\n"
          + "\010polyline\030\002"
          + " \001(\0132+.google.cloud.datalabeling.v1beta1.PolylineH\000\022T\n"
          + "\023normalized_polyline\030\003"
          + " \001(\01325.google.cloud.datalabeling.v1beta1.NormalizedPolylineH\000\022J\n"
          + "\017annotation_spec\030\001"
          + " \001(\01321.google.cloud.datalabeling.v1beta1.AnnotationSpecB\006\n"
          + "\004poly\"\242\002\n"
          + "\033ImageSegmentationAnnotation\022o\n"
          + "\021annotation_colors\030\001 \003(\0132T.google.cloud.datalabeli"
          + "ng.v1beta1.ImageSegmentationAnnotation.AnnotationColorsEntry\022\021\n"
          ...
          + "le.cloud.datalabeling.v1beta1.AnnotationSpec:\0028\001\"j\n"
          ...
          + "\017annotation_spec\030\001"
          + " \001(\01321.google.cloud.datalabeling.v1beta1.AnnotationSpec\022P\n"
          + "\022sequential_segment\030\002"
          + " \001(\01324.google.cloud.datalabeling.v1beta1.SequentialSegment\"/\n"
          ...
          + " \001(\0132..google.cloud.datalabeling.v1beta1.TimeSegment\022J\n"
          + "\017annotation_spec\030\002"
          + " \001(\01321.google.cloud.datalabeling.v1beta1.AnnotationSpec\"\376\001\n"
          ...
          + ".cloud.datalabeling.v1beta1.NormalizedBoundingPolyH\000\022.\n"
          ...
          + " \001(\0132..google.cloud.datalabeling.v1beta1.TimeSegment\022V\n"
          + "\026object_tracking_frames\030\003"
          + " \003(\01326.google.cloud.datalabeling.v1beta1.ObjectTrackingFrame\"\250\001\n"
          + "\024VideoEventAnnotation\022J\n"
          + "\017annotation_spec\030\001 \001(\01321.goo"
          + "gle.cloud.datalabeling.v1beta1.AnnotationSpec\022D\n"
          + "\014time_segment\030\002"
          + " \001(\0132..google.cloud.datalabeling.v1beta1.TimeSegment\"d\n"
          + "\022AnnotationMetadata\022N\n"
          + "\021operator_metadata\030\002"
          + " \001(\01323.google.cloud.datalabeling.v1beta1.OperatorMetadata\"]\n"
          ...
          + "%com.google.cloud.datalabeling.v1beta1P\001ZMgoogle.golang.org/genproto/googl"
          + "eapis/cloud/datalabeling/v1beta1;datalabeling\252\002!Google.Cloud.DataLabeling.V1Beta"
          + "1\312\002!Google\\Cloud\\DataLabeling\\V1beta1\352\002$"
          + "Google::Cloud::DataLabeling::V1beta1b\006proto3"
    };
    descriptor =
