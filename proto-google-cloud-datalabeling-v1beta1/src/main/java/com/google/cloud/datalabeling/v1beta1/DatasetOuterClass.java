...
public final class DatasetOuterClass {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          + "/google/cloud/datalabeling/v1beta1/dataset.proto\022!google.cloud.datalabeling.v1b"
          + "eta1\032\034google/api/annotations.proto\032\031goog"
          + "le/api/resource.proto\0322google/cloud/datalabeling/v1beta1/annotation.proto\032;googl"
          + "e/cloud/datalabeling/v1beta1/annotation_spec_set.proto\0325google/cloud/datalabelin"
          + "g/v1beta1/data_payloads.proto\032?google/cloud/datalabeling/v1beta1/human_annotatio"
          + "n_config.proto\032\037google/protobuf/timestamp.proto\"\300\002\n"
          + "\007Dataset\022\014\n"
          + "\004name\030\001 \001(\t\022\024\n"
          + "\014display_name\030\002 \001(\t\022\023\n"
          + "\013description\030\003 \001(\t\022/\n"
          + "\013create_time\030\004 \001(\0132\032.google.protobuf.Timestamp\022E\n\r"
          + "input_configs\030\005"
          + " \003(\0132..google.cloud.datalabeling.v1beta1.InputConfig\022\032\n"
          + "\022blocking_resources\030\006 \003(\t\022\027\n"
          + "\017data_item_count\030\007 \001(\003:O\352AL\n"
          + "#datalabeling.googleapis."
          + "com/Dataset\022%projects/{project}/datasets/{dataset}\"\361\003\n"
          + "\013InputConfig\022H\n\r"
          + "text_metadata\030\006"
          + " \001(\0132/.google.cloud.datalabeling.v1beta1.TextMetadataH\000\022B\n\n"
          + "gcs_source\030\002 \001(\0132,.google.cloud.datalabeling.v1beta1.GcsSourceH\001\022L\n"
          + "\017bigquery_source\030\005 \001(\01321.goog"
          + "le.cloud.datalabeling.v1beta1.BigQuerySourceH\001\022>\n"
          + "\tdata_type\030\001 \001(\0162+.google.cloud.datalabeling.v1beta1.DataType\022J\n"
          + "\017annotation_type\030\003"
          + " \001(\01621.google.cloud.datalabeling.v1beta1.AnnotationType\022Z\n"
          + "\027classification_metadata\030\004 \001(\01329.google.cloud.datal"
          + "abeling.v1beta1.ClassificationMetadataB\024\n"
          + "\022data_type_metadataB\010\n"
          + "\006source\"%\n"
          + "\014TextMetadata\022\025\n\r"
          + "language_code\030\001 \001(\t\"0\n"
          ...
          + " \001(\01321.google.cloud.datalabeling.v1beta1.GcsDestinationH\000\022Y\n"
          + "\026gcs_folder_destination\030\002"
          + " \001(\01327.google.cloud.datalabeling.v1beta1.GcsFolderDestinationH\000B\r\n"
          + "\013destination\"7\n"
          ...
          + "\010DataItem\022H\n\r"
          + "image_payload\030\002 \001(\0132/.googl"
          + "e.cloud.datalabeling.v1beta1.ImagePayloadH\000\022F\n"
          + "\014text_payload\030\003"
          + " \001(\0132..google.cloud.datalabeling.v1beta1.TextPayloadH\000\022H\n\r"
          + "video_payload\030\004"
          + " \001(\0132/.google.cloud.datalabeling.v1beta1.VideoPayloadH\000\022\014\n"
          + "\004name\030\001 \001(\t:f\352Ac\n"
          + "$datalabeling.googleapis.com/Da"
          + "taItem\022;projects/{project}/datasets/{dataset}/dataItems/{data_item}B\t\n"
          + "\007payload\"\377\004\n"
          + "\020AnnotatedDataset\022\014\n"
          + "\004name\030\001 \001(\t\022\024\n"
          + "\014display_name\030\002 \001(\t\022\023\n"
          + "\013description\030\t \001(\t\022N\n"
          + "\021annotation_source\030\003"
          + " \001(\01623.google.cloud.datalabeling.v1beta1.AnnotationSource\022J\n"
          + "\017annotation_type\030\010"
          + " \001(\01621.google.cloud.datalabeling.v1beta1.AnnotationType\022\025\n\r"
          + "example_count\030\004 \001(\003\022\037\n"
          + "\027completed_example_count\030\005 \001(\003\022B\n"
          + "\013label_stats\030\006"
          + " \001(\0132-.google.cloud.datalabeling.v1beta1.LabelStats\022/\n"
          + "\013create_time\030\007 \001(\0132\032.google.protobuf.Timestamp\022M\n"
          + "\010metadata\030\n"
          + " \001(\0132;.google.cloud.datalabeling.v1beta1.AnnotatedDatasetMetadata\022\032\n"
          + "\022blocking_resources\030\013 \003(\t:~\352A{\n"
          + ",datalabeling.googleapis.com/AnnotatedDataset\022Kprojects/{project}/datasets/{datase"
          + "t}/annotatedDatasets/{annotated_dataset}\"\231\001\n\n"
          + "LabelStats\022V\n\r"
          + "example_count\030\001 \003(\0132?"
          + ".google.cloud.datalabeling.v1beta1.LabelStats.ExampleCountEntry\0323\n"
          + "\021ExampleCountEntry\022\013\n"
          + "\003key\030\001 \001(\t\022\r\n"
          + "\005value\030\002 \001(\003:\0028\001\"\242\010\n"
          + "\030AnnotatedDatasetMetadata\022c\n"
          + "\033image_classification_config\030\002 \001(\0132<.google.cloud.da"
          + "talabeling.v1beta1.ImageClassificationConfigH\000\022U\n"
          + "\024bounding_poly_config\030\003 \001(\01325.g"
          + "oogle.cloud.datalabeling.v1beta1.BoundingPolyConfigH\000\022L\n"
          + "\017polyline_config\030\004 \001(\01321"
          + ".google.cloud.datalabeling.v1beta1.PolylineConfigH\000\022T\n"
          + "\023segmentation_config\030\005 \001(\013"
          + "25.google.cloud.datalabeling.v1beta1.SegmentationConfigH\000\022c\n"
          + "\033video_classification_config\030\006 \001(\0132<.google.cloud.datalabeli"
          + "ng.v1beta1.VideoClassificationConfigH\000\022[\n"
          + "\027object_detection_config\030\007 \001(\01328.google"
          + ".cloud.datalabeling.v1beta1.ObjectDetectionConfigH\000\022Y\n"
          + "\026object_tracking_config\030\010 "
          + "\001(\01327.google.cloud.datalabeling.v1beta1.ObjectTrackingConfigH\000\022F\n"
          + "\014event_config\030\t"
          + " \001(\0132..google.cloud.datalabeling.v1beta1.EventConfigH\000\022a\n"
          + "\032text_classification_config\030\n"
          + " \001(\0132;.google.cloud.datalabeling.v1beta1.TextClassificationConfigH\000\022f\n"
          + "\035text_entity_extraction_config\030\013 \001(\0132=.googl"
          + "e.cloud.datalabeling.v1beta1.TextEntityExtractionConfigH\000\022Y\n"
          + "\027human_annotation_config\030\001"
          + " \001(\01328.google.cloud.datalabeling.v1beta1.HumanAnnotationConfigB\033\n"
          + "\031annotation_request_config\"\316\003\n"
          + "\007Example\022H\n\r"
          + "image_payload\030\002"
          + " \001(\0132/.google.cloud.datalabeling.v1beta1.ImagePayloadH\000\022F\n"
          + "\014text_payload\030\006"
          + " \001(\0132..google.cloud.datalabeling.v1beta1.TextPayloadH\000\022H\n\r"
          + "video_payload\030\007 \001(\0132/"
          + ".google.cloud.datalabeling.v1beta1.VideoPayloadH\000\022\014\n"
          + "\004name\030\001 \001(\t\022B\n"
          + "\013annotations\030\005"
          + " \003(\0132-.google.cloud.datalabeling.v1beta1.Annotation:\211\001\352A\205\001\n"
          + "#datalabeling.googleapis.com/Example\022^projects/{project}/data"
          + "sets/{dataset}/annotatedDatasets/{annotated_dataset}/examples/{example}B\t\n"
          + "\007payload*W\n"
          + "\010DataType\022\031\n"
          ...
          + "%com.google.cloud.datalabeling.v1beta1P\001ZMgoogle.golang.org/genpr"
          + "oto/googleapis/cloud/datalabeling/v1beta1;datalabeling\252\002!Google.Cloud.DataLabeli"
          + "ng.V1Beta1\312\002!Google\\Cloud\\DataLabeling\\V"
          + "1beta1\352\002$Google::Cloud::DataLabeling::V1beta1b\006proto3"
    };
    descriptor =
